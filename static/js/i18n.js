...
(function () {
  const T = {
    zh: {
      ...
      // ── Alibaba Cloud / Lark data sources ────────────────────────
      'sidebar.connect_maxcompute': '🟠 连接 MaxCompute / DataWorks',
      'sidebar.connect_selectdb': '🟢 连接 SelectDB',
      'sidebar.connect_oss': '🪣 连接 OSS 文件',
      'sidebar.connect_lark': '📋 连接 Lark 在线表格',
      'modal.mc.title': '🟠 连接 MaxCompute / DataWorks',
      'modal.mc.name_label': '显示名称（可选）',
      'modal.mc.name_ph': '例如：生产数仓',
      'modal.mc.project_label': '项目名 (Project)',
      'modal.mc.endpoint_label': 'Endpoint',
      'modal.mc.akid_label': 'AccessKey ID',
      'modal.mc.aksecret_label': 'AccessKey Secret',
      'modal.sdb.title': '🟢 连接 SelectDB',
      'modal.sdb.name_label': '显示名称（可选）',
      'modal.sdb.name_ph': '例如：SelectDB 实时数仓',
      'modal.sdb.host_label': 'Host',
      'modal.sdb.port_label': '端口（默认 9030）',
      'modal.sdb.user_label': '用户名',
      'modal.sdb.password_label': '密码',
      'modal.sdb.database_label': '数据库名',
      'modal.oss.title': '🪣 连接 OSS 文件',
      'modal.oss.name_label': '显示名称（可选）',
      'modal.oss.endpoint_label': 'Endpoint',
      'modal.oss.bucket_label': 'Bucket',
      'modal.oss.object_label': '对象 Key（.xlsx/.xls/.csv）',
      'modal.oss.akid_label': 'AccessKey ID',
      'modal.oss.aksecret_label': 'AccessKey Secret',
      'modal.lark.title': '📋 连接 Lark 在线表格',
      'modal.lark.hint': '需先在「MCP 设置」中添加并连接 Lark MCP 服务器。',
      'modal.lark.name_label': '显示名称（可选）',
      'modal.lark.server_label': 'Lark MCP 服务器 ID',
      'modal.lark.token_label': '电子表格 token',
      'modal.lark.ranges_label': '范围 / Sheet（可选，逗号分隔）',
      'modal.lark.tool_label': '读取工具名（可选，留空自动探测）',
      // ── Preview modal ────────────────────────────────────────────
      ...
      'settings.test': '测试',
      'settings.acct_label': '账号名称（多账号用）',
      'settings.acct_label_ph': '例如：企业版 / Pro 版',
      'settings.acct_label_required': '添加账号需填写账号名称',
      'settings.add_account': '＋ 添加为新账号',
      'settings.accounts': '已配置账号',
      'settings.acct_active': '当前',
      'settings.acct_use': '设为当前',
      'settings.acct_switched': '已切换账号 ✓',
      ...
      'confirm.delete_account': '确认删除此账号？',
      ...
      'cmd.larkdoc.desc': '导出分析报告到 Lark 在线文档（需 Lark MCP）',
    ...
    en: {
      ...
      // ── Alibaba Cloud / Lark data sources ────────────────────────
      'sidebar.connect_maxcompute': '🟠 Connect MaxCompute / DataWorks',
      'sidebar.connect_selectdb': '🟢 Connect SelectDB',
      'sidebar.connect_oss': '🪣 Connect OSS File',
      'sidebar.connect_lark': '📋 Connect Lark Sheet',
      'modal.mc.title': '🟠 Connect MaxCompute / DataWorks',
      'modal.mc.name_label': 'Display name (optional)',
      'modal.mc.name_ph': 'e.g. Production Warehouse',
      'modal.mc.project_label': 'Project',
      'modal.mc.endpoint_label': 'Endpoint',
      'modal.mc.akid_label': 'AccessKey ID',
      'modal.mc.aksecret_label': 'AccessKey Secret',
      'modal.sdb.title': '🟢 Connect SelectDB',
      'modal.sdb.name_label': 'Display name (optional)',
      'modal.sdb.name_ph': 'e.g. SelectDB Realtime Warehouse',
      'modal.sdb.host_label': 'Host',
      'modal.sdb.port_label': 'Port (default 9030)',
      'modal.sdb.user_label': 'Username',
      'modal.sdb.password_label': 'Password',
      'modal.sdb.database_label': 'Database',
      'modal.oss.title': '🪣 Connect OSS File',
      'modal.oss.name_label': 'Display name (optional)',
      'modal.oss.endpoint_label': 'Endpoint',
      'modal.oss.bucket_label': 'Bucket',
      'modal.oss.object_label': 'Object Key (.xlsx/.xls/.csv)',
      'modal.oss.akid_label': 'AccessKey ID',
      'modal.oss.aksecret_label': 'AccessKey Secret',
      'modal.lark.title': '📋 Connect Lark Sheet',
      'modal.lark.hint': 'Add and connect a Lark MCP server in "MCP Settings" first.',
      'modal.lark.name_label': 'Display name (optional)',
      'modal.lark.server_label': 'Lark MCP server ID',
      'modal.lark.token_label': 'Spreadsheet token',
      'modal.lark.ranges_label': 'Ranges / Sheets (optional, comma-separated)',
      'modal.lark.tool_label': 'Read tool name (optional, auto-detect if blank)',
      // ── Preview modal ────────────────────────────────────────────
      ...
      'settings.test': 'Test',
      'settings.acct_label': 'Account name (for multi-account)',
      'settings.acct_label_ph': 'e.g. Enterprise / Pro',
      'settings.acct_label_required': 'An account name is required to add an account',
      'settings.add_account': '＋ Add as new account',
      'settings.accounts': 'Configured accounts',
      'settings.acct_active': 'Active',
      'settings.acct_use': 'Use',
      'settings.acct_switched': 'Account switched ✓',
      ...
      'cmd.larkdoc.desc': 'Export analysis report to a Lark online doc (needs Lark MCP)',
